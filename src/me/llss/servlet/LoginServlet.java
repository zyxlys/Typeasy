...
public class LoginServlet extends HttpServlet {
	...
	public boolean validateLogin(HttpServletRequest request,
		...
		boolean flag = true;
		String loginMessage = "";
		String name = Html2Text.HtmlToText(request.getParameter("user_login"));
		String password = Html2Text.HtmlToText(request.getParameter("user_pwd"));
	...
	public void login(HttpServletRequest request, HttpServletResponse response)
		...
		if (flag) {
			...
			String name = Html2Text.HtmlToText(request
					.getParameter("user_login"));
			String password = md5.getMD5ofStr(Html2Text.HtmlToText(request
	...
	public void register(HttpServletRequest request,
		...
		String password = md5.getMD5ofStr(Html2Text.HtmlToText(request
				.getParameter("user_pwd")));
		String mail = Html2Text.HtmlToText(request.getParameter("user_email"));
		String screenName = Html2Text.HtmlToText(request
