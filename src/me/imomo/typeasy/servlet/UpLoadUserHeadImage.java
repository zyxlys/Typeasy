...
import me.imomo.typeasy.jspsmart.upload.File;
import me.imomo.typeasy.jspsmart.upload.SmartUpload;
...
public class UpLoadUserHeadImage extends HttpServlet {
	...
	private String sPath = "/uploads/UploadPhoto";
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			response.sendRedirect("../uploadimage.jsp?Picurl="
					+ FileName + "&step=2");
		} catch (Exception e) {
			e.printStackTrace();
		}
