			...
			<tbody>
				<c:forEach var="content" items="${contents }">
					<tr>
						...
						<td>该数数在relationship获取</td>
						<td>${content.created }</td>
						<td>${content.commentsNum }</td>
						<td><a
							href="servlet/ContentsServlet?action=find&type=post&cid=${content.cid}"><img
								src="images/icn_edit.png" title="编辑" style="border:0px;"></a>
							<a
							href="servlet/ContentsServlet?action=del&type=post&cid=${content.cid}"><img
