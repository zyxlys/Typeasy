...
<section id="main" class="column">
	...
	<article class="module width_full">
		<form id="edit-page"
			action="servlet/ContentsServlet?action=edit&type=page&cid=${content.cid }" method="post">
			<header>
				<h3>修改页面</h3>
			</header>
			<div class="module_content">
				<fieldset>
					<label>页面标题</label> <input type="text" value="${content.title }" id="title" name="title">
				</fieldset>
				<fieldset>
					<label>页面内容</label>
