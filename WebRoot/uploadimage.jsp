...
<body>
    ...
    <div>
     <div class="left">
           ...
           <div class="uploadtooltip">您可以拖动照片以裁剪满意的头像</div>                              
                   <div id="Canvas" class="uploaddiv">
                            ...
                            <div id="ImageDragContainer">                               
                               <img id="ImageDrag" class="imagePhoto" src="uploads/UploadPhoto/<%=picUrl %>" style="border-width:0px;" />                                                        
                            </div>
                            <div id="IconContainer">                               
                               <img id="ImageIcon" class="imagePhoto" src="uploads/UploadPhoto/<%=picUrl%>" style="border-width:0px;" />                                                        
                            </div>                          
                    </div>
                    <div class="uploaddiv">
                       <table>
      ...
      <form name="form1" method="post" action="servlet/UpLoadUserHeadImage" id="form1" enctype="multipart/form-data">
     <div class="right">
         <!--Step 1-->
